...
class ProfileViewModelTest {
    ...
    fun `Get profile should return success`() {
        testCoroutineRule.runBlockingTest {
            ...
            val userProfile = when (val userProfileState = profileViewModel._userProfileState) {
    ...
    fun `Get profile should return fail`() {
        testCoroutineRule.runBlockingTest {
            ...
            val isSuccess = when (val userProfileState = profileViewModel._userProfileState) {
